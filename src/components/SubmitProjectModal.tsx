          ...
          <div className="relative z-10 w-full max-w-2xl rounded-2xl border border-neutral-200 bg-white p-6 shadow-2xl">
            <div className="flex items-start justify-between gap-4">
              ...
              <button
                ...
                disabled={pending}
                aria-label="닫기"
                className="-mr-1 -mt-1 rounded-full p-1.5 text-neutral-500 transition hover:bg-neutral-100 hover:text-neutral-900 disabled:opacity-50"
              >
                <svg
                  width="18"
                  height="18"
            ...
            <form ref={formRef} action={formAction} className="mt-5">
              <div className="grid gap-4">
                <div>
                  <label
                    htmlFor="title"
                    className="mb-1.5 block text-xs font-medium uppercase tracking-widest text-neutral-700"
                  >
                    제목
                  </label>
                  <input
                ...
                <div>
                  <p className="mb-1.5 text-xs font-medium uppercase tracking-widest text-neutral-700">
                    썸네일 미리보기
                  </p>
                  <input type="hidden" name="image_url" value={previewUrl ?? ""} />
                  <div className="flex aspect-video w-full items-center justify-center overflow-hidden rounded-lg border border-neutral-200 bg-neutral-100">
                    {previewing ? (
              ...
              <div className="mt-6 flex items-center justify-end gap-2">
                <button
                  ...
                  disabled={pending}
                  className="inline-flex h-11 items-center justify-center rounded-full px-5 text-sm font-medium text-neutral-600 transition hover:bg-neutral-100 hover:text-neutral-900 disabled:opacity-50"
                >
                  취소
                </button>
                <button
                  type="submit"
                  disabled={pending}
                  className="inline-flex h-11 items-center justify-center rounded-full bg-neutral-900 px-6 text-sm font-medium text-white transition hover:bg-neutral-800 disabled:cursor-not-allowed disabled:opacity-60"
                >
                  {pending ? "AI 분석 중…" : "등록"}
                </button>
              </div>
